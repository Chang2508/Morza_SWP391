<%-- 
    Document   : index
    Created on : Feb 7, 2023, 6:33:59 PM
    Author     : DELL
--%>
                      ...
                      <div class="slider_item-detail">
                        <div>
                          ...
                          <p>
                            ...
                            make the most enjoyable shopping of your life.
                          </p>
                          <div class="d-flex">
              ...
              <div class="slider_item-container">
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="hero_img-box">
                        <img src="images/ship-onl.png" alt="" 
                             width="400" 
     height="600"/>
                      </div>
                    </div>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="detail_img-box">
            <img src="images/girl_shop.png" alt="" class="w-100" />
          </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="shoe_img-box">
                  <img src="images/vege-cart.png" alt="" />
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="item_container">
        <div class="row">
          <div class="col-sm-7">
            <h3>
              Best offers on any sweets 
            </h3>
            <p>
              We have all the sweets you could dream of!
            </p>
            <div>
              <a href="">
                Shop Now
          ...
          <div class="col-sm-5">
            <div class="item_img-box">
              <img src="images/snack2.png" alt="" w />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-5">
          ...
          <p>
            Register if you want to receive more promotional information from us
          </p>
        </div>
        <div class="col-md-7">
          <form action="">
